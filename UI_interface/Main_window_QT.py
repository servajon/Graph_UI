...
class Edit_view_data(QWidget):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "<html><head/><body><p><span style=\" font-size:14pt;\"></span></p></body></html>"))
    ...
    def change_current(self):
        if self.listWidget.currentItem() is not None:
            if self.listWidget.currentItem().foreground().color() == QColor("green") and self.pushButton.text() == "Add":
                self.pushButton.setText("Remove")
            elif self.listWidget.currentItem().foreground().color() == QColor("black") and self.pushButton.text() == "Remove":
                self.pushButton.setText("Add")
