...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        """self.view_values = QtWidgets.QListView(self.verticalLayout_left)
...
class Cycle_Selection(QWidget):
    ...
    def create_cycle_to_layout(self):
        ...
        self.lineEdit_2 = self.Line_edit(self)
        ...
        self.lineEdit_3 = self.Line_edit(self)
    ...
    def create_cycle_numbers_layout(self):
        ...
        self.lineEdit_5 = self.Line_edit(self)
    ...
    def save(self):
        if self.cycle_to_layout is not None:
            if int(self.lineEdit_2.text()) > int(self.lineEdit_3.text()):
                self.emit.emit("msg_console", type="msg_console", str="Left number is largeur than the right one",
                               foreground_color="red")
            else:
                self.finish_signal.emit(
                    {"rep": "save", "arg": "to", "arg1": [int(self.lineEdit_2.text()), "to",
            ...
            array.sort()
            self.finish_signal.emit({"rep": "save", "arg": "selected", "arg1": array})

        else:
            self.finish_signal.emit({"rep": "save", "arg": "all"})

    def cancel(self):
        self.finish_signal.emit({"rep": "cancel"})
